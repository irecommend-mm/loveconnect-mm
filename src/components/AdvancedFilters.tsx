...
const AdvancedFilters = ({ currentMode, onClose, onApplyFilters }: AdvancedFiltersProps) => {
  ...
  const handleApplyFilters = () => {
    const filters = {
      ...
      relationshipType: relationshipType === 'any' ? null : relationshipType,
      height: height === 'any' ? null : height,
      education: education === 'any' ? null : education,
      smoking: smoking === 'any' ? null : smoking,
      drinking: drinking === 'any' ? null : drinking,
      exercise: exercise === 'any' ? null : exercise,
      verified,
      hasPhotos,
      recentlyActive,
    };
      ...
      <Card className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <Select value={height} onValueChange={setHeight}>
              ...
              <SelectContent>
                ...
                <SelectItem value="under_5_5">Under 5'5"</SelectItem>
                <SelectItem value="5_5_to_5_9">5'5" - 5'9"</SelectItem>
                <SelectItem value="5_10_to_6_1">5'10" - 6'1"</SelectItem>
                <SelectItem value="over_6_1">Over 6'1"</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-medium text-gray-800">Lifestyle Preferences</h3>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <Select value={smoking} onValueChange={setSmoking}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="yes">Regular</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                ...
                <Select value={drinking} onValueChange={setDrinking}>
                  ...
                  <SelectContent>
                    <SelectItem value="any">Any</SelectItem>
                    <SelectItem value="no">Never</SelectItem>
                    <SelectItem value="sometimes">Social</SelectItem>
                    <SelectItem value="yes">Regular</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                <label className="text-sm font-medium block mb-2">Exercise</label>
